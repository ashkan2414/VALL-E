...
namespace valle
{
    ...
    // =============================================================================
    namespace hardware_build::internal
    {
        template <typename TStorage>
        struct HardwareBuildBase
        {
            TStorage storage;

            explicit HardwareBuildBase(TStorage&& storage_init) : storage(std::move(storage_init))
            {
            }
        };
        ...
        struct GlobalDeviceStorageAccessor
        {
            ...
            TDevice& get()
            {
                return static_cast<HardwareBuild*>(gp_system_hardware)->storage.template get<TDevice>();
            }
        };
    ...
    public:
        ...
        {
            return hardware_build::internal::GlobalDeviceStorageAccessor{}.get<DeviceT>();
        }
