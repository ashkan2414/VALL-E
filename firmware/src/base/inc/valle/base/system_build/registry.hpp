...
namespace valle
{
    ...
    namespace detail
    {
        ...
        struct IsReady
        {
            ...
            {
                (void)deps;  // Silence unused parameter warning
        ...
        struct BatchClaimer
        {
            ...
            {
                (void)needs;  // Silence unused parameter warning
    ...
    struct DeviceRefRegistry
    {
         ...
         * @note This consumes the DeviceRefRegistry (it is an r-value method). Shared resources copy ref, unique
        ...
        template <CSharedDevice... TDevices>
            requires(sizeof...(TDevices) > 1)
        [[nodiscard]] auto get(TypeList<TDevices...> devices) const
        {
            (void)devices;  // Silence unused parameter warning
            return get<TDevices...>();
        }
    ...
    class DeviceStorage
    {
        ...
        friend system_build::internal::GlobalDeviceStorageAccessor;  // Allow access to get()
