...
namespace valle::app
{
    ...
    static void init_root()
    {
        g_drivers.root.foreach (DeviceInitOverloaded{
            ...
            { expect(dev.init(kCurrentSensorADCCommonConfig), "Failed to initialize ADC 12 Clock Device"); },
    ...
    static void post_init_root()
    {
        g_drivers.root.foreach_reverse(DeviceInitOverloaded{
            ...
            [](ADC12CommonDevice& dev) { expect(dev.post_init(), "Failed to post-initialize ADC 12 Clock Device"); },
