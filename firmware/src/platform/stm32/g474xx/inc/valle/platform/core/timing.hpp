...
#include "valle/base/platform_support/system_interface/timing.hpp"
...
namespace valle::platform
{
    ...
    // CLOCKS
    // =========================================================================
    using PlatformTimingConfigT          = typename CTConfigRegistryT::TimingConfigT;
    ...
    struct TimingContext
        : public platform_support::system_interface::TimingContextBase<TimingWaitPolicy, SystemClock, CycleClock>
    {
        // =========================================================================
        // CYCLE UTILS
        // =========================================================================
        using CyclesTraitsT =
            platform_support::system_interface::PeriodTimingTraits<typename CycleClock::period, CycleClock>;
        ...
        using TimingUtilsCycleT =
            platform_support::system_interface::PeriodTimingUtils<CyclesTraitsT, TimingWaitPolicy>;
         ...
         */
        template <platform_support::system_interface::CTimeoutConditionFunc TFunc>
