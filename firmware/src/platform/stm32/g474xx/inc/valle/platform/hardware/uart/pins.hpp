...
namespace valle::platform
{
    ...
    template <UartPeripheralId tkPeripheralId, GpioPortId port, GpioPinId pin, UartPinType tkType>
    ...
    concept CValidUartPin =
        requires { typename UartGpioPinAF<tkPeripheralId, port, pin, tkType>::NoAFDefinedTag; } == false;
...
#define REGISTER_UART_PIN(uart_id, port_id, pin_id, pin_type, af_id) \
    ...
    // USART1
    REGISTER_UART_PIN(UartPeripheralId::kUSART1,
                      GpioPortId::kPortA,
                      GpioPinId::kPin8,
                      UartPinType::kCK,
    ...
    // USART2
    REGISTER_UART_PIN(UartPeripheralId::kUSART2,
                      GpioPortId::kPortA,
                      GpioPinId::kPin0,
                      UartPinType::kCTS,
                      GpioAlternativeFunction::kAF7);
    ...
    // USART3
    REGISTER_UART_PIN(UartPeripheralId::kUSART3,
                      GpioPortId::kPortA,
                      GpioPinId::kPin13,
                      UartPinType::kCTS,
                      GpioAlternativeFunction::kAF7);
    ...
    // Uart4
    REGISTER_UART_PIN(UartPeripheralId::kUart4,
                      GpioPortId::kPortA,
                      GpioPinId::kPin15,
                      UartPinType::kRTS,
    ...
    // Uart5
    REGISTER_UART_PIN(UartPeripheralId::kUart5,
                      GpioPortId::kPortB,
                      GpioPinId::kPin4,
                      UartPinType::kRTS,
                      GpioAlternativeFunction::kAF8);
    ...
    // LPUart1
    REGISTER_UART_PIN(UartPeripheralId::kLPUart1,
                      GpioPortId::kPortA,
                      GpioPinId::kPin2,
                      UartPinType::kTx,
