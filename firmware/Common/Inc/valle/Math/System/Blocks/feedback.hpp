...
private:
    ...
    ValueT       m_last_output;
    ValueT       m_min_tolerance;

public:
    explicit inline FeedbackSystem(TOpenLoopSys &open_loop, ValueT min_tolerance = static_cast<ValueT>(1e-6))
...
template <CSystemOrRef                                     TOpenLoopSys,
          CFeedbackFunction<typename TOpenLoopSys::ValueT> TFeedbackFn = std::function<typename TOpenLoopSys::ValueT()>>
