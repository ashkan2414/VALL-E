...
# MCU specific flags
set(TARGET_FLAGS "--target=arm-none-eabi -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard ${TOOLCHAIN_MULTILIBS}")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -ferror-limit=5 -ftemplate-backtrace-limit=3")

set(CMAKE_C_FLAGS_DEBUG "-ggdb3 -Og -g3 -fno-omit-frame-pointer")
set(CMAKE_CXX_FLAGS_DEBUG "-ggdb3 -Og -g3 -fno-omit-frame-pointer")
